...
const Login = () => {
    return (
        ...
        <div className='signup-container w-full h-screen bg-gray-50'>
                    <div className=' flex items-center justify-center py-12 m-auto sm:w-[360px] '>
                        <div className='w-full'>
                            ...
                            <h1 className='px-4 text-2xl text-slate-900 font-medium'>Welcome to Shopzilla,</h1>
                                <p className='px-4 pb-4 text-2xl text-slate-900 font-medium'>Sign UP to Continue.</p>
                                <div className='p-2 '>
                                    <div className='px-3 bg-white flex items-center  border rounded-md border-slate-400'>
                                        ...
                                        <input className='text-sm focus:outline-none w-full p-3' type="email" placeholder='Email address' />
                                    </div>
                                </div>
                                <div className='p-2'>
                                    <div className='px-3 bg-white flex items-center  border rounded-md border-slate-400'>
                                ...
                                <div className='p-2'>
                                    <div className='px-3 bg-white flex items-center  border rounded-md border-slate-400'>
                                        <MdPassword size={20} className=' text-gray-500 font-md' />
                                        <input className='text-sm focus:outline-none w-full p-3' type="email" placeholder='Confirm Password' />
                                    </div>
                                </div>
                                <div className='p-2 pt-4'>
                                    <button className='rounded-full text-sm bg-stone-900 text-white p-3 w-full'>Register</button>
                                </div>
                            </form>
                            ...
                            <div className='text-sm'>
                                ...
                                <div className='p-2 pt-4'>
                                    <Link to="/login" className='flex items-center justify-center rounded-full outline outline-stone-900 hover:bg-stone-900 hover:text-white p-3 w-full'>Login</Link>
                                </div>
                            </div>
                        </div>
                    </div>
